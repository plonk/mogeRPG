...
(defconstant +level_1+ 9)
(defconstant +level_2+ 10)
(defconstant +level_3+ 11)
(defconstant +level_4+ 12)
(defconstant +boss+    13)
...
(defun style->attr (style)
  (case style
    ...
    (:level_1 (color-pair +level_1+))
    (:level_2 (color-pair +level_2+))
    (:level_3 (color-pair +level_3+))
    (:level_4 (color-pair +level_4+))
    (:boss    (color-pair +boss+))
...
(defun init-charms ()
  ...
  (init-pair +level_1+ COLOR_CYAN    COLOR_BLACK)
  (init-pair +level_2+ COLOR_GREEN   COLOR_BLACK)
  (init-pair +level_3+ COLOR_YELLOW  COLOR_BLACK)
  (init-pair +level_4+ COLOR_RED     COLOR_BLACK)
  (init-pair +boss+    COLOR_MAGENTA COLOR_BLACK)
